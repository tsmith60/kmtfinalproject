...
public class MapViewerTest extends FreeColTestCase {
 ...
 public void tearDown() throws Exception {
     ...
     super.tearDown();
			 ...
			 public void testSetAct(){
				 
				 //Tests the set active unit method in MapViewer
				 ...
				 try {
			            ...
			            MapViewer tempMap = new MapViewer(client);
			            ...
			            assertTrue(tempMap.setActiveUnit(hardyPioneer));
